...
public final class ZlibUtils {
	...
	/** 解压任务线程池 */
	private static ExecutorService executorService = Executors.newCachedThreadPool(new NamedThreadFactory(
			new ThreadGroup("ZlibUtils"), "解压处理"));
	...
	public static void main(String[] args) throws Exception {
		...
		System.arraycopy(src, 0, newSrc, 0, newSrc.length);

		System.out.println(src.length);

		Inflater inflater = new Inflater();
		inflater.setInput(newSrc);
